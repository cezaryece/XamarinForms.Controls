	...
	public class App : Application
	{
		...
		public App()
		{
				...
				Setters =
			{
				...
				new Setter { Property = Label.FontSizeProperty, Value = CommonFontSize }
			}
			});
			...
			Current.Resources.Add("SectionTitle", new Style(typeof(Label))
			{
				Setters = {
					...
					new Setter { Property = Label.FontSizeProperty, Value = CommonFontSize * 1.5 }
				}
			});
