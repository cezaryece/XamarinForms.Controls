...
namespace TestLib
{
	public class TestLibViewModel : INotifyPropertyChanged
	{
		...
		public List<CheckBoxItem> EventsItems
		{
			get => _eventsItems;
			set
			{
		...
		public List<string> ComboItems => new List<string> { "pierwszy", "drugi", "trzeci", "czwarty", "piąty" };
		...
		public Dictionary<string, ContentView> TabedViews
		{
			get => _tabedViews;
			set
			{
		...
		public TestLibViewModel()
		{
			...
			{
				{ "pierwszy", new ContentView { Content = new Label { Text = "label1" } } }, { "drugi", new ContentView { Content = new Label { Text = "label2" } } }, { "trzeci", new ContentView { Content = new Label { Text = "label3" } } }
				, { "czwarty", new ContentView { Content = new Label { Text = "label4" } } }, { "piąty", new ContentView { Content = new Label { Text = "label5" } } }
				, { "szósty", new ContentView { Content = new Label { Text = "label6" } } }, { "7", new ContentView { Content = new Label { Text = "7" } } }, { "8", new ContentView { Content = new Label { Text = "8" } } }
				, { "9", new ContentView { Content = new Label { Text = "9" } } }, { "10", new ContentView { Content = new Label { Text = "10" } } }, { "11", new ContentView { Content = new Label { Text = "11" } } }
			};
			...
			{
				new DateTimeItem(3, "item1"), new DateTimeItem(5, "item2"), new DateTimeItem(7, "item3")
			};
			SetEventsItems();
		}
